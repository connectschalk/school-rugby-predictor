-- Persist contributor governance flags on story submission.

alter table public.memory_stories
  add column if not exists sponsor_or_brand_visible boolean not null default false;
...
revoke all on function public.submit_memory_story(uuid, uuid, uuid, text, text, uuid, double precision, double precision, double precision, double precision, text, text, text, integer, text, text, text, boolean, boolean, boolean, boolean, boolean, boolean, text[], jsonb) from public;
grant execute on function public.submit_memory_story(uuid, uuid, uuid, text, text, uuid, double precision, double precision, double precision, double precision, text, text, text, integer, text, text, text, boolean, boolean, boolean, boolean, boolean, boolean, text[], jsonb) to authenticated;
