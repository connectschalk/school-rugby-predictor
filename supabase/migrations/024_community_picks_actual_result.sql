-- Community picks: expose final score, actual winner/margin for header and chart marker.
...
comment on function public.get_community_prediction_stats(uuid) is
  'Bucketed margin distribution, signed community average, optional final score fields, kickoff gate unchanged.';
