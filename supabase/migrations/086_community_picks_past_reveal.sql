-- Community picks RPC: reveal completed fixtures, rugby-only margin picks, zero-prediction safe.

-- Soccer community picks: return top 5 scorelines and one-decimal community average.
